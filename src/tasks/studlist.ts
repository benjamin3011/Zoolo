...
bot.tasks.set(`studlists`, {
  ...
  execute: function () {
    ...
    const json = fetch("https://api.zed.run/api/v1/stud/horses?offset=0&bloodline[]=Szabo&bloodline[]=Nakamoto&breed_type[]=genesis&gen[]=1&gen[]=4&horse_name=&sort_by=mating_price_lowest");
